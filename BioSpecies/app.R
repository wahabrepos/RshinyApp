...
server <- function(input, output) {
  ...
  gs4_auth(email = "ayaandawo175@gmail.com", cache = cache_directory)
  journal_url <- "https://docs.google.com/spreadsheets/d/1WtlIVZPEmlugUhchaosdJtnna4gSlqdWzRFfpl3Zjvc/edit?gid=1109172106#gid=1109172106"
